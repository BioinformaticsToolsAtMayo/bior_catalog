...
### Format:
###  chr  .  .  minBP  maxBP  majorAlleleIndex  minorAlleleIndex  ACount  CCount  GCount  TCount  alleleFreq  minBP  refAllele  isInDbSNP
echo -e "###chr\t.\t.\tminBP\tmaxBP\tmajIdx\tminIdx\tAs\tCs\tGs\tTs\tFreqs\tminBpOrig\tRefAllele\tisInDbSNP"  >  $scratch/2.mafPlusRef.tsv
paste  $scratch/1.maf.sorted.tsv  $scratch/1.genotype.part.sorted.tsv  \
  | awk -F \\t '{print $1 FS "." FS "." FS $2 FS $2 FS $3 FS $4 FS $5 FS $6 FS $7 FS $8 FS "\""$9"\"" FS $11 FS $12 FS $13}'  \
...
### Re-sort the file
sort -k1,1 -k4,4 $scratch/3.mafPlusRef.liftedOver.tsv > $scratch/4.mafPlusRef.liftedOver.sorted.tsv
