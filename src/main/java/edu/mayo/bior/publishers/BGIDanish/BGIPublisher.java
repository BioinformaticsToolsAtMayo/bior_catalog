...
//        System.out.println(args.length);
    ...
    public void publish(String rawDataFileFullpath, String outputDir, Pipe out) {
        ...
        Injector[] injectors = new Injector[] {
            ...
            new ColumnInjector(3, "index_of_major_allele", JsonType.NUMBER),
            new ColumnInjector(4, "index_of_minor_allele", JsonType.NUMBER),
            new ColumnInjector(5, "number_A", JsonType.NUMBER),
            new ColumnInjector(6, "number_C", JsonType.NUMBER), 
            new ColumnInjector(7, "number_G", JsonType.NUMBER),
            new ColumnInjector(8, "number_T", JsonType.NUMBER),
